...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 glass-effect border-b border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-primary-500 to-purple-500 rounded-lg" />
            <span className="text-lg sm:text-xl font-bold">Dimension</span>
          </div>
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            {["About", "Careers", "Blog", "Changelog"].map((item, idx) => (
              <button
                key={item}
                className="relative px-3 lg:px-4 py-1 rounded-lg font-medium text-gray-300 hover:text-white transition-colors focus:outline-none group"
          ...
          <button className="button-primary text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">
            Join waitlist
          </button>
        </div>
      </nav>
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 bg-black">
        ...
        >
          ...
          {/* Glowing Arc Animation */}
          <motion.path
            d="M 350 400 A 200 200 0 0 1 850 400"
            fill="none"
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          ...
          <div className="absolute top-1/4 left-1/4 w-48 h-48 sm:w-72 sm:h-72 md:w-96 md:h-96 bg-pink-500/20 rounded-full blur-3xl animate-float" />
          <div
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center bg-white/5 border border-white/10 rounded-xl px-4 py-4 shadow-xl relative z-10">
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 sm:px-8 py-3 rounded-xl font-bold text-base sm:text-lg bg-gradient-to-r from-pink-400 via-pink-300 to-yellow-300 text-white shadow-lg focus:outline-none focus:ring-4 focus:ring-primary-300 transition-all hover:scale-105"
              >
                Join waitlist
              </button>
            </div>
          ...
          >
            <div className="glass-effect rounded-2xl p-4 sm:p-6 lg:p-8 max-w-5xl w-full">
              ...
              <div className="bg-dark-800 rounded-lg p-4 sm:p-6 text-left">
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-4">
                  <div className="flex items-center gap-2">
                    <MessageSquare className="w-4 h-4 text-primary-400" />
                    <span className="text-primary-400 text-sm sm:text-base">
                      Chat
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-dark-800">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="glass-effect rounded-xl p-4 sm:p-6 hover:bg-white/20 transition-all duration-300"
              >
                <feature.icon className="w-10 h-10 sm:w-12 sm:h-12 text-primary-400 mb-3 sm:mb-4" />
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-dark-900">
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center gap-3 sm:gap-4">
                  <kbd className="px-2 sm:px-3 py-1 bg-dark-800 border border-white/20 rounded text-xs sm:text-sm font-mono min-w-[3rem]">
                    ⌘K
                  </kbd>
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="glass-effect rounded-2xl p-4 sm:p-6 lg:p-8 hidden md:block"
            >
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass-effect rounded-2xl p-4 sm:p-6 flex flex-col gap-3 shadow-xl"
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex items-center gap-2 bg-white/5 rounded-lg px-2 sm:px-3 py-2"
                  >
                    <span className="w-4 h-4 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center flex-shrink-0">
                      <svg
                        width="12"
                        height="12"
                        viewBox="0 0 20 20"
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-dark-800 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="flex flex-col lg:flex-row gap-4 sm:gap-6 justify-center items-start mx-auto max-w-4xl"
          >
            {/* Sidebar */}
            <div className="glass-effect rounded-2xl p-3 sm:p-4 w-full lg:w-64 flex-shrink-0 shadow-xl text-left">
            ...
            <div className="flex-1 min-w-0 w-full">
              ...
              <div className="flex gap-1 sm:gap-2 mb-2 overflow-x-auto">
                {["main.rs", "configure.rs", "mod.rs", "app.rs"].map(
                  (tab, i) => (
                    <div
                      key={tab}
                      className={`px-2 sm:px-4 py-1 rounded-t-lg font-mono text-xs whitespace-nowrap ${
                        i === 0
              ...
              {/* Code Box */}
              <div className="glass-effect rounded-b-2xl p-3 sm:p-4 font-mono text-xs text-left text-gray-200 leading-relaxed shadow-xl overflow-x-auto min-h-[180px] sm:min-h-[220px]">
...
`}</code>
          ...
          >
            ...
            <div className="relative inline-block">
              ...
              <motion.button
                ...
                className="relative z-20 px-6 sm:px-8 lg:px-10 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg bg-gradient-to-r from-primary-500 via-purple-500 to-primary-400 text-white shadow-xl focus:outline-none focus:ring-4 focus:ring-primary-300"
              >
                Join waitlist
              </motion.button>
            </div>
      ...
      {/* Footer */}
      <footer className="bg-dark-900 py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-gray-400">
            <p className="text-sm sm:text-base">
              &copy; 2025 Realm Software Inc. All rights reserved.
            </p>
